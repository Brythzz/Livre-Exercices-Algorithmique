...
\lstinputlisting[linerange={1-40}]{\SourceFile}
...
\lstinputlisting[linerange={42-65}]{\SourceFile}
...
\lstinputlisting[linerange={67-73}]{\SourceFile}

Puis on obtient :

\lstinputlisting[firstline=75]{\SourceFile}
